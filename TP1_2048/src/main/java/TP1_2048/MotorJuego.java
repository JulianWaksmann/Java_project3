...
public class MotorJuego implements IMotorJuego, IObservadorUIJuego{
	...
	* *****************************************************/
	...
	private boolean perdioJuego() {
		...
		while (!puedeMover && filaColumna < this.tamanioTablero) {
	...
	/*
	 * no hace falta verificar en un solo sentido horizontal y un solo sentido vertical 
	 */
	private boolean puedeMover(int filaColumna) {
		...
		while (!puedeMover && indice < this.tamanioTablero - 1) {
			...
			puedeMover = puedeMover || this.tablero[filaColumna][indice] == 0 || this.tablero[filaColumna][indice + 1] == 0 || this.tablero[filaColumna][indice] == this.tablero[filaColumna][indice + 1];
			
			//verifica si puede mover a la izquierda
			//puedeMover = puedeMover || this.tablero[filaColumna][this.tamanioTablero - indice - 1] == 0 || this.tablero[filaColumna][this.tamanioTablero - indice - 2] == 0 || this.tablero[filaColumna][this.tamanioTablero - indice - 1] == this.tablero[filaColumna][this.tamanioTablero - indice - 2];
			
			//verifica si puede mover hacia abajo
			puedeMover = puedeMover || this.tablero[indice][filaColumna] == 0 || this.tablero[indice + 1][filaColumna] == 0 || this.tablero[indice][filaColumna] == this.tablero[indice + 1][filaColumna];
			
			//verifica si puede mover hacia arriba
			//puedeMover = puedeMover || this.tablero[this.tamanioTablero - indice - 1][filaColumna] == 0 || this.tablero[this.tamanioTablero - indice - 2][filaColumna] == 0 || this.tablero[this.tamanioTablero - indice - 1][filaColumna] == this.tablero[this.tamanioTablero - indice - 2][filaColumna];
 ...
 // Crear tablero en todos los observadores
    ...
    public void nuevoRecord() {
    	ejecutarEnObservadores(observador -> observador.NuevoRecord(this.mejorPuntaje));
    }
}
